...
<br>
	<center><h3>Find Our Pantry's Appointments</h3>
	<form action="appointments.do" method="post">
		<input type="submit" />
	</form></center>
<br>
<br>
	<center><h3>Show stuff short in stock:</h3>
	<form action="short.do">
		<input type="submit" />
	</form></center>
<br>
<br>
	<center><h3>Refill Inventory Item</h3></center>
	<form action="refill.do">
		<center><input type="submit" /></center>
	</form>

	<center><c:if test="${not empty appointments}">
